...
import { Heart, Users, BarChart3, MapPin } from "lucide-react";
...
export default function InfluencerCard({ influencer }: InfluencerCardProps) {
  ...
  const [isFavorite, setIsFavorite] = useState(!!influencer.isFavorite);
    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {Array.isArray(influencer.platform) &&
            influencer.platform.slice(0, 2).map((platform, index) => (
              <span
                key={index}
        ...
        <div className="flex flex-wrap gap-2">
          {Array.isArray(influencer.topics) &&
            influencer.topics.slice(0, 2).map((topic, index) => (
              <span
                key={index}
